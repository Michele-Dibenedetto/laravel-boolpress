...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <form action="{{route("posts.store")}}" method="post" enctype="multipart/form-data">  {{-- {{ route('admin.posts.store') }} --}}
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="testo" class="form-control @error('testo') is-invalid @enderror" rows="10" placeholder="Inizia a scrivere qualcosa..." required>{{ old('testo') }}</textarea>
                    @error('testo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
