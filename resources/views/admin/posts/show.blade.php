...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <a href="{{route("posts.edit", $post->id)}}" {{-- {{ route('admin.posts.edit', ['post' => $post->id]) }} --}}
            ...
            <form class="d-inline-block" action="{{route("posts.destroy", $post->id)}}" method="post"> {{-- {{ route('admin.posts.destroy', ['post' => $post->id]) }} --}}
                @csrf
                @method('DELETE')
